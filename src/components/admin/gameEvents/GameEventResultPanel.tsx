...
// Roulette es rojo salvo el 0 (verde), Pick 3 es azul, Pick 4 es morado (pedido explícito: mismo
// color y tipografía que ahí, reutilizando directamente sus clases .admin-round-pill(-group) en vez
// de duplicar el estilo).
function getTone(game: GameEventGame, value: number): 'red' | 'green' | 'blue' | 'purple' {
  if (game === 'roulette') return value === 0 ? 'green' : 'red'
  return game === 'pick3' ? 'blue' : 'purple'
}
