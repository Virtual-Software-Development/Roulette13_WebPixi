...
export const ADMIN_SIDEBAR_ITEMS: AdminSidebarItem[] = [
  ...
  // Not part of the original mock -- added only so the real, working Game Config (above, via
  // "settings") and Media Library pages have a way to be reached from the sidebar at all. Nothing
  // else in this file changed. See admin/src/layout/AdminShell.tsx for the id -> route mapping.
  {
    id: 'mediaLibrary',
    labelKey: 'admin.nav.mediaLibrary',
